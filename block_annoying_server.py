...
if __name__ == '__main__':
    ...
    for i in result["response"]["servers"]:
        ...
        re.search("[^非]rpg|戮|弑|巅|凡|玄|天下|神域|完美世界|一念仙行录|窥仙之路|风花雪月|暗黑之魂|午夜狂欢|無人永生|神之右手|军魂|星缘|破晓|腐尸之地|猎人|通天塔|无法逃脱|穷途末路|众神传说|上帝|HTの|破晓|星缘天空|午夜狂欢|鹅服|阿起世界", i["name"], re.RegexFlag.I) or \
